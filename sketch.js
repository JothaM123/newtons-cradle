...
function setup() {
	...
	bob1 = Bodies.circle(300, 400, 40,bob_options);
	World.add(world,bob1);

	bob2 = Bodies.circle(320, 400, 40,bob_options);
	World.add(world,bob2);

	bob3 = Bodies.circle(340, 400, 40,bob_options);
	World.add(world,bob3);

	bob4 = Bodies.circle(380, 400, 40,bob_options);
	World.add(world,bob4);	

	bob5 = Bodies.circle(400, 400, 40,bob_options);
...
function keyPressed(){
	if(keyCode === UP_ARROW){
		Matter.Body.applyForce(bob1,bob1.position,{x:-300,y:0});
	}
}